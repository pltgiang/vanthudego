...
export default function IncomingDocumentForm() {
  ...
  // We need multiple dropdown states for each user select field
  ...
  const handleSave = async () => {
    ...
    try {
      toast.success('Đã lưu văn bản đến thành công')
  ...
  return (
    <div className="company-info-page h-100">
      ...
      <div className="topbar dis-flex align-items-center">
        ...
        <div className="page-title mb-0 flex1" style={{ marginLeft: 8 }}>Thêm mới văn bản đến</div>
      ...
      <div className="content scrollable company-blocks-layout" style={{ padding: '24px 0' }}>
        ...
        <div className="company-card info-section">
          ...
          <div className="section-body grid-2">
            ...
            <div className="field">
              <label>Ngày trên văn bản <span className="req">*</span></label>
            ...
            <div className="field">
              ...
              <input type="text" className="form-control" placeholder="Nhập thông tin liên hệ" value={formData.contact_info} onChange={e => handleChange('contact_info', e.target.value)} />
            </div>

            <div className="field col-span-2">
              <label>Nơi gửi</label>
              <div className="dis-flex gap-8">
                <button className="btn outline dis-flex align-items-center gap-8"><i className="ti ti-plus"></i> Thêm nơi gửi</button>
          ...
          <div className="section-body grid-2">
            <div className="field">
              ...
              <select className="form-control" value={formData.doc_form} onChange={e => handleChange('doc_form', e.target.value)}>
                <option value="">Chọn hình thức văn bản</option>
            ...
            <div className="field">
              ...
              <select className="form-control" value={formData.urgency_level} onChange={e => handleChange('urgency_level', e.target.value)}>
                <option value="">Chọn mức độ khẩn</option>
            ...
            <div className="field">
              ...
              <select className="form-control" value={formData.register_book} onChange={e => handleChange('register_book', e.target.value)}>
                ...
                <option value="SoDen2023">Sổ đến 2023</option>
              </select>
            </div>
            ...
            <div className="field">
              ...
              <input type="date" className="form-control" value={formData.received_date} onChange={e => handleChange('received_date', e.target.value)} />
            </div>
            ...
            <div className="field">
              <label>Số đến</label>
              <input type="text" className="form-control" placeholder="Nhập số đến" value={formData.incoming_no} onChange={e => handleChange('incoming_no', e.target.value)} />
            </div>
